...
class AmplProblem(amplpy.AMPL):
    ...
    def write_parameters(self):
        ...
        self.mod_string += "/* PROBLEM PARAMETERS */\n\n"
        self.mod_string += """
    ...
    def write_variables(self):
        # Adds the problem sets to the mod file string
        self.mod_string += "/* PROBLEM VARIABLES */\n\n"
        self.mod_string += """
    ...
    def write_constraints(self):
        ...
        if self.has_time_dependent_energy_prices > 0:
            ...
            self.mod_string += "s.t. calculate_operating_cost_time_dependent{u in markets, l in layersOfUnit[u]}: layer_operating_cost[u,l] = sum{t in timeSteps} (power[u,l,t] * ENERGY_PRICE[l] * ENERGY_PRICE_VARIATION[l,t]) * TIME_STEP_DURATION * OCCURRANCE;\n"
        else: 
            self.mod_string += "s.t. calculate_operating_cost_standard{u in markets, l in layersOfUnit[u]}: layer_operating_cost[u,l] = sum{t in timeSteps} (power[u,l,t] * ENERGY_PRICE[l]) * TIME_STEP_DURATION * OCCURRANCE;\n"
